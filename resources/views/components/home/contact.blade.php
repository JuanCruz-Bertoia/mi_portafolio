                 ...
                 ">
                    ...
                    <div class="flex mb-8 max-w-[370px] w-full">
                     ...
                     ">
                        ...
                        <div class="w-full">
                            <h4 class="font-bold text-dark dark:text-gray-200 text-xl mb-1">Ubicación</h4>
                    ...
                    <div class="flex mb-8 max-w-[370px] w-full">
                     ...
                     ">
                        ...
                        <div class="w-full">
                            <h4 class="font-bold text-dark dark:text-gray-300 text-xl mb-1">Teléfono</h4>
                            <p class="text-base text-body-color dark:text-gray-300">3407-15436507</p>
                        </div>
                    </div>
                </div>
            </div>
